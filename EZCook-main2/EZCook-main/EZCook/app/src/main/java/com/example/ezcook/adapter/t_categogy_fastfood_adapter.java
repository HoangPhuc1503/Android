...
//        imgAddToSave = itemView.findViewById(R.id.image_save_suggest);
    ...
    @NonNull
    @Override
    public t_categogy_fastfood_adapter.viewholder_fastfood onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view_foastfood = LayoutInflater.from(parent.getContext()).inflate(R.layout.t_item_food, parent, false);
        return new t_categogy_fastfood_adapter.viewholder_fastfood(view_foastfood);
    }
